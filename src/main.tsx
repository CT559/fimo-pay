...
// Studio watermark — dời lên trên bottom nav, opacity thấp, không che nội dung
const StudioWatermark = () => (
  <a
    ...
    style={{
      position: 'fixed',
      bottom: '72px',   /* trên bottom nav ~64px */
      right: '12px',
      display: 'flex',
      alignItems: 'center',
      gap: '4px',
      ...
      textDecoration: 'none',
      cursor: 'pointer',
      background: 'rgba(172, 198, 233, 0.55)',
      backdropFilter: 'blur(8px)',
      WebkitBackdropFilter: 'blur(8px)',
      borderRadius: '12px',
      border: '1px solid rgba(255, 255, 255, 0.35)',
      zIndex: 18,          /* dưới bottom nav (z-20) */
      opacity: 0.7,
      pointerEvents: 'auto',
    }}
  >
